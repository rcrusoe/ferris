class EventsController < ApplicationController
  ...
  def event_params
    params.require(:event).permit(:title, :description, :place_id, :date, :start_time, :end_time, :address, :neighborhood, :website, :price, :purchase_url, :image, :short_blurb, :repeat_weekly)
  end
end
