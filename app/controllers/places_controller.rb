class PlacesController < ApplicationController
  ...
  private
    ...
    def place_params
      params.require(:place).permit(:name, :description, :full_address, :website, :phone_number, :image, :approved, open_times_attributes: [:id, :day, :open_time, :close_time, :_destroy])
    end
end
